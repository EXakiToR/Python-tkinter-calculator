"""
Смысл даже есть там, где кажется его нет
Недопонятые баги:
    1)Операции возведения в степень с минусом
    2)Процент от числа (переход в экспоненциальную форму -> процент от степени а не от всего числа)
"""
import time as t
